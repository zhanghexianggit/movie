 ...
 * function:热门电影
 */
public class HotAdapter extends RecyclerView.Adapter<HotAdapter.MovieViewHolder> {
    List<HotMovieBean.ResultBean> resultBeanList;
    private Context context;

    public HotAdapter(List<HotMovieBean.ResultBean> resultBeanList, Context context) {
